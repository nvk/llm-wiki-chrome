...
class AdapterAndSecurityTests(unittest.TestCase):
    def test_manifest_is_private_route_free_and_content_free(self) -> None:
        ...
        self.assertEqual(extension["name"], "LLM Wiki for Chrome")
        self.assertEqual(extension["action"]["default_title"], "LLM Wiki for Chrome")
...
'''
    ...
    def test_side_panel_is_status_only(self) -> None:
        ...
        self.assertIn("<h1>LLM Wiki for Chrome</h1>", html)
